...
session_start();
    ...
    require 'assets/partials/_userlogin.php';
    $conn = db_connect();    
...
<body>
    ...
    <header>
        <nav>
            <div>
                   <img src="newlogo.png" style="width:23%;margin-left:-159px;"><a href="#" class="nav-item nav-logo">Wanderu</a>
                    <!-- <a href="#" class="nav-item">Gallery</a> -->
                   
            </div>
                
            <ul>
                <li><a href="index1.php" class="nav-item">Home</a></li>
                <li><a href="aboutus.php" class="nav-item">About</a></li>
                <li><a href="contactus.php" class="nav-item">Contact</a></li>
                <li><a href="#">Login</a>
                <ul>
                   <li><a href="#userlogin" class="login nav-item" data-bs-toggle="modal" data-bs-target="#userloginModal">User Login</a></li>
                    <li><a href="#loginModal" class="login nav-item" data-bs-toggle="modal" data-bs-target="#adminloginModal">Admin Login</a></li>
                </ul>
        </li>
                <li><a href="#pnr-enquiry" class="nav-item">pnr enquiry</a></li>
        </ul>
            </div>
                <div>
                    <h3 style="font-size:21px;text-transform:capitalize;margin-top:-25px;margin-right:-60px;"><b>&nbsp;<?php echo $_SESSION['cname']; ?></b></h3>&nbsp;
                    <br><h4><a href="userlogout.php" style="text-decoration:none;color:red;font-size:12px;margin-top:50px;margin-right:-10px;"><a href="index.php">&nbsp;Logout</a></h4>
                    <img src="assets/img/adminprof1.jpg" style="width:45px;height:45px;float:right;margin-right:-180px;margin-top:-40px;" alt="userprofile">
            </div><br>
        </nav>
        </header>
    <!-- Login Modal -->
    <?php require 'assets/partials/_adminloginModal.php';
     require 'assets/partials/_userlogin.php'; 
     require 'assets/partials/bookticket.php';
    ...
    <section id="home">
        <div id="route-search-form">
            <center>
            <br><h1><br><br>Books Ticket at cheaper rates</h1>

            <p class="text-center"><br>Welcome to Wanderu. Login to book tickets</p>

            
               <br> <button class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#"><a href="checkbus_sch.php" style="color:white;text-decoration:none;">Check Bus Schedules</a></button>
                
            </center>

            <br>
            <center>
            <a href="#bookticket"><button class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#bookticketModal">Book Tickets&nbsp;<i class="fa fa-ticket"></i></button></a>
            </center>
