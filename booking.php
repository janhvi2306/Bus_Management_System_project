...
<body>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
            ...
            <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                <div id="head">
                    <h4>Booking Status</h4><br><br>
                </div>
                <input type="date"  placeholder="From Date" style="width:20%;font-size:20px;" name="fromdate">&nbsp;<i class="fa fa-arrow-right" aria-hidden="true" style="width:30px;font-weight:bolder;font-size:35px;color:red;"></i>
                <input type="date"  placeholder="Till Date"  style="width:20%;font-size:20px;" name="todate">&emsp;&emsp;
                <input type="submit" style="font-size:20px;border-radius:10px;color:white;" class="button edit-button btn-sm" name="submitdt" value="Submit">
               <br><br>
                <div id="booking-results">
                    <div>
                        ...
                        <br><br>
                        <input type="submit" class="btn btn-success" type="button" name="displayall" value="Display All Bookings">
                    </div>
            </form>
...
<!-- Add, Edit and Delete Bookings -->
        ...
        */
        ...
        if(isset($_POST["submitdt"]))
        {
            ...
            $todate=$_POST['todate'];
            $sql ="SELECT * FROM `bookings` where booking_created BETWEEN '$fromdate' AND '$todate' ORDER BY booking_created;";           
        ...
        if($total== "0")
        {
            echo "<center><h1 style='color:red;'>No Records Found</h1></center>";
        }
        else
        {
            ?>
           ...
           <input type="button" value="Print" onclick="window.print()" class='btn btn-success'>
           <?php } 
           ?>
           <?php
        }
        ...
        */
        ...
        {
            $sql ="SELECT * FROM `bookings`  ORDER BY booking_created;";           
            $result = mysqli_query($conn, $sql); 
            $total=mysqli_num_rows($result);
        ?>
        ...
        if($total== "0")
        {
            echo "<center><h1 style='color:red;'>No Record Found</h1></center>";
        }
        else
        {
            ?>
    ...
    ?>
        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                {
                    // Show success alert
                    $messageHeading = "Successfull! booking added";

                    echo '<div class="my-0 alert alert-alert-dismissible fade show" role="alert">
                    <strong>'.$messageHeading.'</strong> Please note your Prn Number :<h3>' .$booking_id. '</h3>
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                                    <input type="text" class="form-control searchInput" id="sourceSearch" name="sourceSearch" readonly>
                                    <div class="sugg">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                                    <input type="text" class="form-control searchInput" id="destinationSearch" name="destinationSearch" readonly>
                                    <div class="sugg">
                                    </div>
                                </div>
                            </div>
