...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["pnr-search"]))
    {
        ...
        if($num)
        {
            ...
            $dep_date = get_from_table($conn, "bookings", "booking_id", $pnr, "Jdate");
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <p>
                Do you really want to cancel your booking? <strong>This process cannot be undone.</strong>
            </p>
            <!-- Needed to pass pnr -->
      ...
      <div class="modal-footer">
        <button type="submit" form="delete-form" class="btn btn-primary btn-danger" name="deleteBtn">Cancel Booking</button>
      </div>
    </div>
  </div>
</div>
<section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box" data-aos="fade-up">
                ...
                <a href="#"> <i class="fas fa-envelop"></i> janhvi_harsh@gmail.com </a>
            ...
            <div class="box" data-aos="fade-up">
                ...
                <a href="#"> <i class="fab fa-pinterest"></i> pinInterest </a>
            </div>
